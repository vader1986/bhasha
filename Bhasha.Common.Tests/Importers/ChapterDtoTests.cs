...
namespace Bhasha.Common.Tests.Importers
{
    ...
    public class ChapterDtoTests
    {
        ...
        public void Deserialize_from_JSON()
        {
            ...
            Assert.That(result.Pages.Length == 2);
            ...
            Assert.That(result.Pages[0].Token.Categories.SequenceEqual(new[] { "pet", "animal" }));
            ...
            Assert.That(result.Pages[1].Token.Categories.SequenceEqual(new[] { "pet", "animal" }));
